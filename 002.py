...
def process_sheet_data():
    input_file_path = r'D:\Personal\Desktop\ALL DATA\Similarity\ATC\ATC_Breast.xlsx'
    output_file_path = r'D:\Personal\Desktop\ALL DATA\Similarity\ATC\ATC_Breast_1.xlsx'
